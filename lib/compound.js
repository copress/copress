...
Compound.prototype.loadNamedConfigs = function loadNamedConfigs(path) {
    var app = this.app;
    var config = ConfigLoader.load("", app.get('env'), path, function mergeAppConfig(target, config, fileName) {
