...
describe('Generators API', function() {
    ...
    it('should generate app', function () {
        ...
        output.should.eql([
            ...
            'create  config/config.development.json',
            'create  config/config.production.json',
            'create  config/config.test.json',
            'create  config/components.json',
            'create  config/middleware.json',
            'create  config/middleware.development.json',
            'create  config/middleware.test.json',
